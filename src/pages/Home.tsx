            ...
            <div className="content-wrapper">
                ...
                <aside className="sidebar">
                    <div className="sidebar-article">
                        ...
                        <div><Link to="/article/id:402"
                        style= {{textDecoration: "none", color:"inherit"}}>
                        A Fiscal Playground: California K-12 Funding</Link></div>
                        <p className="article-author">Natalia Armas Perez - Aug 30, 2024</p>
                    </div>
                    <div className="sidebar-article">
                        <img src={galaxyimg} alt="Sidebar Article" className="sidebar-image" />
                        <div><Link to="/article/id:502"
                        style= {{textDecoration: "none", color:"inherit"}}>
                        Never Again is Right Now</Link></div>
                        <p className="article-author">The Politic - May 19, 2024</p>
                    </div>
                    <div className="sidebar-article">
                        <img src={galaxyimg} alt="Sidebar Article" className="sidebar-image" />
                        <div><Link to="/article/id:602"
                        style= {{textDecoration: "none", color:"inherit"}}>
                        The Rise of the AFD in Germany</Link></div>
                        <p className="article-author">Nicole Chen - Apr 28, 2024</p>
                    </div>
                    <div className="sidebar-article">
                        <img src={galaxyimg} alt="Sidebar Article" className="sidebar-image" />
                        <div><Link to="/article/id:702"
                        style= {{textDecoration: "none", color:"inherit"}}>
                        Journalism Isn’t Dying, it’s Transforming</Link></div>
